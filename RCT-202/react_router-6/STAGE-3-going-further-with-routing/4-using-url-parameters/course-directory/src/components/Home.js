...
const Home = () => {
  ...
  return (
    ...
    <Link to="teachers/CSS/Bart-Simpson">Bart Simpson</Link>
    <Link to="teachers/CSS/Sam-America">Sam America</Link>
    <Link to="teachers/JavaScript/Johnny-English">Johnny English</Link>
    </div>
  );
}
